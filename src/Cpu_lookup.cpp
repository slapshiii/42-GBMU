...
instruction instructions[0x100] = {
	...
	[0xE2] = {IN_JP , AM_D16  , RT_NONE, RT_NONE, CT_NC},
	//[0xE3],
	[0xE4] = {IN_CALL,AM_D16  , RT_NONE, RT_NONE, CT_NC},
	[0xE5] = {IN_PUSH,AM_R    , RT_DE},
	[0xE6] = {IN_SUB, AM_R_D8 , RT_A},
	[0xE7] = {IN_RST, AM_IMP  , RT_NONE, RT_NONE, CT_NONE, 0x10},
	[0xE8] = {IN_RET, AM_IMP  , RT_NONE, RT_NONE, CT_C},
	[0xE9] = {IN_RETI},
	[0xEA] = {IN_JP , AM_D16  , RT_NONE, RT_NONE, CT_C},
	 //[0xEB],
	[0xEC] = {IN_CALL,AM_D16  , RT_NONE, RT_NONE, CT_C},
	//[0xED],
	[0xEE] = {IN_SBC, AM_R_D8, RT_A},
	[0xEF] = {IN_RST, AM_IMP  , RT_NONE, RT_NONE, CT_NONE, 0x18},
